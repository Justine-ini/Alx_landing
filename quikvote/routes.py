...
from quikvote.models import User, Election, Candidate, Vote
from quikvote.form import RegistrationForm, LoginForm, UpdateAccountForm
from quikvote import app, db, bcrypt
